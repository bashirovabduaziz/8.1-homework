  ...
  return (
    <>
      <div className="mt-[100px] w-full mb-[100px]">
        <p className="text-[64px] leading-[65px] mb-[70px] font-semibold  text-[#1b5bf7]">
          Development of mobile <br /> applications
        </p>
        <div className="flex items-center justify-between">
          <div>
            <p className="text-[20px] mb-[40px] font-semibold text-[#464359]">
              In collaboration with startups, we have <br /> learned how to
              create a creative and <br /> functional user interface for mobile{" "}
              <br /> applications.
            </p>
            <div className="flex items-center mb-[50px] gap-[15px]">
              <div className="bg-[#f4f7ff] w-[160px] rounded-[8px] pr-[20px] py-[10px]">
                <img
            ...
            <p className="text-[#464359]  text-[32px] font-bold mb-[10px]">
              Technologies
            </p>
            <div className="flex items-center gap-[50px]">
              <div className="flex flex-col items-center justify-center gap-[5px]">
                <img
                  ...
                  alt="rasm"
                />
                <p className="font-semibold text-[20px] ">Swift</p>
              </div>
              <div className="flex flex-col items-center justify-center gap-[5px]">
                <img
                  ...
                  alt="rasm"
                />
                <p className="font-semibold text-[20px] ">Kotlin</p>
              </div>
              <div className="flex flex-col items-center justify-center gap-[5px]">
                <img
                  ...
                  alt="rasm"
                />
                <p className="font-semibold text-[20px] ">Flutter</p>
              </div>
            </div>
          </div>
