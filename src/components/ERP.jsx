...
const ERP = () => {
  return (
    <>
      <div className="w-full bg-[#f4f7ff] pb-[80px] mb-[100px]">
        <div className="w-[1150px] flex items-center justify-between pt-[60px] m-auto">
          <div>
            <p className="text-[64px] font-semibold mb-[70px] text-[#1b5bf7]">
              ERP systems
            </p>
            <div className="relative ">
              ...
              />
              <img
                className="absolute top-[60px] w-[500px]"
          ...
          <div className="mt-[120px]">
            <p className="text-[20px] mb-[40px] font-semibold text-[#464359]">
              IT Systems of any level of complexity at a <br /> convenient time
              for you
            </p>
            <div className="flex items-center mb-[15px] gap-[15px]">
              <div className="bg-[#e0e8ff] w-[160px] rounded-[8px] pl-[10px] py-[10px]">
                <img
                  ...
                  alt="rasm"
                />
                <p className="font-semibold text-[18px] pl-[10px] mt-[10px]">
                  CRM
                </p>
              </div>
              <div className="bg-[#e0e8ff] w-[160px] rounded-[8px] pl-[10px] py-[10px]">
            ...
            <div className="flex items-center mb-[50px] gap-[15px]">
              <div className="bg-[#e0e8ff] w-[160px] rounded-[8px] pl-[10px] py-[10px]">
                <img
              ...
              <div className="bg-[#e0e8ff] w-[160px] rounded-[8px] pl-[10px] py-[10px]">
                <img
                  ...
                  alt="rasm"
                />
                <p className="font-semibold text-[18px] pl-[0px] mt-[10px]">
                  Sms / Email
                </p>
              </div>
              <div className="bg-[#e0e8ff] w-[160px] rounded-[8px] pl-[10px] py-[10px]">
                <img
                  ...
                  alt="rasm"
                />
                <p className="font-semibold text-[18px] pl-[5px] mt-[10px]">
                  Warehouse
                </p>
              </div>
            </div>
